...
impl<'a> SingleBufferFB<'a> {
  ...
  pub fn message(&self) -> Option<&'a [u8]> {
    self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(SingleBufferFB::VT_MESSAGE, None).map(|v| v.safe_slice())
  }
}
...
impl<'a: 'b, 'b> SingleBufferFBBuilder<'a, 'b> {
  ...
  pub fn add_message(&mut self, message: flatbuffers::WIPOffset<flatbuffers::Vector<'b , u8>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(SingleBufferFB::VT_MESSAGE, message);
  }
  #[inline]
...
pub struct ListFBArgs<'a> {
    pub messages: Option<flatbuffers::WIPOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<SingleBufferFB<'a>>>>>,
}
...
impl<'a: 'b, 'b> ListFBBuilder<'a, 'b> {
  #[inline]
  pub fn add_messages(&mut self, messages: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<SingleBufferFB<'b >>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(ListFB::VT_MESSAGES, messages);
  }
  #[inline]
